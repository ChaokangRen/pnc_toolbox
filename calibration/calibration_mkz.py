...
from sg_vehicle_msgs.msg import ThrottleReport
from sg_vehicle_msgs.msg import BrakeReport
...
class Data_collector(object):
    ...
    def multi_callback(self, throttle_sub, brake_sub, acc_sub, speed_sub):
        ...
        thro = throttle_sub.percent_actual
        brake = brake_sub.percent_actual
        vel = speed_sub.mps
        acc = acc_sub.accel.y
    ...
    def calib(self):
        ...
        throttle_sub = message_filters.Subscriber("/vehicle/throttle/report",
                                                  ThrottleReport)
        brake_sub = message_filters.Subscriber("/vehicle/brake/report",
                                               BrakeReport)
